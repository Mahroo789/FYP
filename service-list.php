...
<head>
    ...
    <title> ZAIB SALON || Service List</title>
    <!-- Bootstrap -->
...
?>
             ...
             <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['ServiceName'];?></td> <td>PKR: <?php  echo $row['Cost'];?></td> <td><?php  echo $row['Description'];?></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
